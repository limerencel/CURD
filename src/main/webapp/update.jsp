				...
				<div class="row">
					<div class="col-sm-5">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="file" name="pic" id="picFile"  style="display: none;" />
								<img src="https://www.baidu.com/favicon.ico" alt="" id="pic" style="cursor: pointer;">
				...
				<div class="row">
					...
					<div class="col-sm-5">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="address" placeholder="请输入籍贯" />
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="username" readonly placeholder="请输入用户名" />
							</div>
						</div>
					</div>
					<div class="col-sm-5">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" name="password" readonly placeholder="请输入员工密码" />
